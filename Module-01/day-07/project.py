...
class Account:
    ...
    def deposit(self , amount):
        ...
        self.history['deposit'] = self.history['deposit'].append(f"Deposited {amount} money")
    ...
    def withdrawal(self , amount):
        ...
        self.__balance -= amount
        self.history['withdrawal'] = self.history['withdrawal'].append(f"Withdrawn {amount} money")
